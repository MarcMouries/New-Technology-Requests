...
Record({
    ...
    data: {
        ...
        x_snc_newtech_phase: 'new_request_submitted',
...
Record({
    ...
    data: {
        ...
        x_snc_newtech_phase: 'initial_review',
...
Record({
    ...
    data: {
        ...
        x_snc_newtech_phase: 'architecture_review',
...
Record({
    ...
    data: {
        ...
        x_snc_newtech_priority: '2_high',
        x_snc_newtech_phase: 'trigger_funding_governance',
