...
export const x_snc_newtech_request = Table({
    ...
    schema: {
        ...
        x_snc_newtech_requester_department: ReferenceColumn({
        ...
        // 7. Priority - Mandatory choice field
        x_snc_newtech_priority: ChoiceColumn({
            ...
            choices: {
                fast_track: { 
                    label: 'Fast Track – Urgent and critical (requires CIO & President approval)', 
                    sequence: 0 
                },
                high: { 
                    label: 'High – Needed within the Year\'s Capital Planning (requires CIO approval)', 
                    sequence: 1 
                },
                medium: { 
                    label: 'Medium – Needed within the next year', 
                    sequence: 2 
                },
                low: { 
                    label: 'Low – Needed when funding and capacity allows', 
                    sequence: 3 
                }
            }
        }),
        ...
        x_snc_newtech_phase: ChoiceColumn({
            ...
            choices: {
                ...
                two_initial_review: { label: '2 - Initial Review', sequence: 1 },
                three_architecture_review: { label: '3 - Architecture Review', sequence: 2 },
                four_proposal: { label: '4 - Proposal', sequence: 3 },
                five_trigger_funding: { label: '5 - Trigger Funding Governance', sequence: 4 }
            }
        }),
